...
knitr::opts_knit$set(root.dir = "C:/@@Roaming_Dogs_Data_Analysis/Reference/@spatial-extremes-v1.0/seananderson-spatial-extremes-8710f51")
getwd()
library(dplyr)
library(ggplot2)
library(glmmfields)
...
saveRDS(d, file = "mountain-pine-beetle-data.rds")
