...
knitr::opts_knit$set(root.dir = "C:/@@Roaming_Dogs_Data_Analysis")
library(dplyr)
library(ggplot2)
library(glmmfields)
library(rstan)
...
d <- readRDS(paste0("C:/@@Roaming_Dogs_Data_Analysis/Reference/@spatial-extremes-v1.0/seananderson-spatial-extremes-8710f51/examples/beetles",
